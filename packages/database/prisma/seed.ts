...
async function main() {
  ...
  console.log('✅ Created pages:', homepage.title, categoryPage.title);
  ...
  console.log('✅ Created SEO opportunity:', opportunity.keyword);
...
From the stunning architecture of Antoni Gaudí to the vibrant energy of Las Ramblas,
...
- Sailing & Beach Activities`,
  ...
  console.log('✅ Created and linked content');
