...
export const JOB_TYPE_TO_QUEUE: Record<string, QueueName> & Record<JobType, QueueName> = {
  ...
  LINK_COMPETITOR_DISCOVERY: QUEUE_NAMES.SEO,
  LINK_BROKEN_LINK_SCAN: QUEUE_NAMES.SEO,
  LINK_CONTENT_GAP_ANALYSIS: QUEUE_NAMES.SEO,
  ...
  SEO_HEALTH_CHECK: QUEUE_NAMES.SEO,
