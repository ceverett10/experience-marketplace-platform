              ...
              nodes: [
                {
                  ...
                  questionList: {
                    nodes: [
                      { id: 'pq-fn', label: 'First name', type: 'TEXT', dataType: 'STRING', answerValue: null, isRequired: true },
                      { id: 'pq-ln', label: 'Last name', type: 'TEXT', dataType: 'STRING', answerValue: null, isRequired: true },
                      { id: 'pq-em', label: 'Email', type: 'EMAIL', dataType: 'STRING', answerValue: null, isRequired: true },
                      { id: 'pq-ph', label: 'Phone number', type: 'PHONE', dataType: 'STRING', answerValue: null, isRequired: true },
                    ],
                  },
                },
                {
                  ...
                  questionList: {
                    nodes: [
                      { id: 'pq-fn2', label: 'First name', type: 'TEXT', dataType: 'STRING', answerValue: null, isRequired: true },
                      { id: 'pq-ln2', label: 'Last name', type: 'TEXT', dataType: 'STRING', answerValue: null, isRequired: true },
                    ],
                  },
                },
              ],
