    ...
    <section className="relative">
      ...
      <div
        className={`relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ${
          isPpc ? 'py-4 sm:py-6' : 'py-14 sm:py-20 md:py-24 lg:py-32'
        }`}
      >
        <div className="mx-auto max-w-4xl text-center">
          <h1
            className={`hero-animate-title font-display font-bold tracking-tight text-white ${
              isPpc
          ...
          <p
            className={`hero-animate-subtitle mx-auto max-w-xl text-white/90 ${
              isPpc
          ...
          {/* Organic: Search widget (PPC skips hero CTA — products shown directly below) */}
          {!isPpc && (
      ...
      {/* Decorative wave transition (organic only) */}
      {!isPpc && (
