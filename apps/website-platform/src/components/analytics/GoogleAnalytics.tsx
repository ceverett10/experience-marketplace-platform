...
/**
 * Google Analytics 4 SPA route change tracking.
 * The gtag.js script is loaded server-side in layout.tsx <head> via
 * beforeInteractive Script for tag verification compatibility.
 * This component only handles client-side navigation page view tracking.
 */
