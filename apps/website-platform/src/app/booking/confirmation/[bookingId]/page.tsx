          ...
          <div className="space-y-4 text-sm text-gray-600">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p>We&apos;ve sent your booking confirmation and e-ticket to {booking.customerEmail}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div
              ...
              <div>
                ...
                <p>Keep your reference number <span className="font-semibold">{bookingId}</span> handy for check-in</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div
        ...
        <div className="mt-6 rounded-xl bg-white p-6 shadow-lg">
          ...
          <div className="flex items-start gap-3 text-sm text-gray-600">
            ...
            <div>
              ...
              <p className="mt-1">
                If you need to cancel, please do so at least 24 hours before your scheduled experience time for a full refund.
              </p>
            </div>
          </div>
        </div>
