...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Always attempt to save regardless of booking state — we've seen silent failures
    // when gating on state and the Holibob API returns an unexpected value
    console.info(
    ...
    try {
      ...
      // Log error AND persist to funnel events so it survives log rotation
