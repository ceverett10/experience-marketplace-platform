...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    const defaultPayloads: Record<string, any> = {
      ...
      CROSS_SITE_LINK_ENRICHMENT: { percentagePerRun: 5 },
      LINK_COMPETITOR_DISCOVERY: { maxSites: 20 },
      LINK_BROKEN_LINK_SCAN: { maxDomains: 20 },
      LINK_CONTENT_GAP_ANALYSIS: { maxSites: 10 },
